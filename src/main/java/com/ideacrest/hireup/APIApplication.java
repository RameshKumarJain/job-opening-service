...
import com.ideacrest.hireup.resource.JobOpeningsResource;
...
public class APIApplication extends Application<APIConfiguration> {
	...
	public void initialize(Bootstrap<APIConfiguration> bootstrap) {
		// Initialise zipkin
		bootstrap.addBundle(new ZipkinBundle<APIConfiguration>("job-openings-service") {
			@Override
	...
	public void run(APIConfiguration configuration, Environment environment) throws Exception {
		...
		// register resources
		environment.jersey().register(injector.getInstance(JobOpeningsResource.class));
